...
### [我的博客在这里 &rarr;](http://Hyper-jiawei.github.io)
...
我的博客仓库——`Hyper-jiawei.github.io`，是经常修改的，因此做了一个稳定版的模板。大家可以直接fork模板——`huxblog-boilerplate`,要改的地方我都说明了。或者可以直接下载zip到本地自己去修改。
